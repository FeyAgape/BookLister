...
public class BookActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNoResultTextView = (TextView) findViewById(R.id.empty_view);
        bookListView.setEmptyView(mNoResultTextView);
...
// Create a new loader for the given URL
        ...
        String searchName = intent.getStringExtra(MainActivity.SEARCH_NAME);
